...
Case_DF = pd.read_csv(r'C:\Users\skankal\Desktop\python\Spark\spark project\archive\Case.csv')
columns = [i.strip() for i in list(Case_DF.columns)]

FILE_PATH = "C:\\Users\\skankal\\Desktop\\python\\Spark\\spark project\\archive\\Case.csv"
...
def main(topic):
    ...
    counter = 0
    try:
        for case in get_case_instance(file_path=FILE_PATH):
            # print(type(case))
            print(case)
