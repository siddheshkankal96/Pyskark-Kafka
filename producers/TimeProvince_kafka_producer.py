...
Case_DF = pd.read_csv(r'C:\Users\skankal\Desktop\python\Spark\spark project\archive\TimeProvince.csv')
columns = [i.strip() for i in list(Case_DF.columns)]

FILE_PATH = "C:\\Users\\skankal\\Desktop\\python\\Spark\\spark project\\archive\\TimeProvince.csv"
...
def main(topic):
    ...
    schema_str = schema_registry_client.get_schema(schema_id = 100012).schema_str
    # print(schema_str)

    # print(schema_str)
    string_serializer = StringSerializer('utf_8')
    json_serializer = JSONSerializer(schema_str, schema_registry_client, timeProvince_to_dict)
    ...
    counter = 0
    try:
        for timeProvince in get_timeProvince_instance(file_path=FILE_PATH):
            # print(type(timeProvince))
            print(timeProvince)
